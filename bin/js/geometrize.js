...
GalleryItem.prototype = {
	get_caption: function() {
		return "<i>" + Std.string(this.shapeCount) + " <a href=\"" + "http://www.geometrize.co.uk/" + this.afterImagePath + "\" target=\"_blank\">" + this.shapeName + "</a>" + "</i>";
	}
};
